...
public final static java.lang.String NOTIFYUSER = "notifyUser";
public final static java.lang.String USERREQUEST = "userRequest";
	...
	public String getString(TourOrder tourOrder) {
		...
		if(tourOrder != null)
		{
			message = tourOrder.userAlias + " " + tourOrder.taxiAlias + " " + tourOrder.address + " " + tourOrder.status;
		}
		return message;
	}
